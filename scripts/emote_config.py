...
class Emote_Config:
    def __init__(self, finetune, model_name, portion, seed, hfpath):
        ...
        self.train_csv_fp = 'benchmark_data/exp-entailment/train5.csv'
        self.val_csv_fp = 'benchmark_data/exp-entailment/val5.csv'
        self.test_csv_fp = 'benchmark_data/exp-entailment/test5.csv'
